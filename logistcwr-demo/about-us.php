...
<head>
	...
	<title> Logistcwr - About Us </title>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp">
				<div class="st__team__box text-center">
					<div class="st__team__thumb">
						<img src="assets/images/team/team.png" alt="Operations Manager">
					</div>
			...
			<div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp">
				<div class="st__team__box text-center">
					<div class="st__team__thumb">
						<img src="assets/images/team/team2.png" alt="Logistics Supervisor">
					</div>
					<div class="st__team__content">
						<h2>Sunil Verma</h2>
			...
			<div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp">
				<div class="st__team__box text-center">
					<div class="st__team__thumb">
						<img src="assets/images/team/team3.png" alt="Packing Specialist">
					</div>
					<div class="st__team__content">
						<h2>Amit Sharma</h2>
						<span>Senior Packing Specialist</span>
						<div class="st__team__social">
							<a href="#"><i class="bi bi-share-fill"></i></a>
							<a href="#"><i class="bi bi-facebook"></i></a>
							<a href="#"><i class="bi bi-instagram"></i></a>
			...
			<div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp">
				<div class="st__team__box text-center">
					<div class="st__team__thumb">
						<img src="assets/images/team/team4.png" alt="Customer Support Manager">
					</div>
					<div class="st__team__content">
						<h2>Neha Gupta</h2>
