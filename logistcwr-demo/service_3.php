...
<head>
	...
	<meta
		name="description"
		content="Mourya Packers & Movers provides professional office shifting services in Faridabad. Safe, fast and hassle-free corporate relocation with minimal downtime and insured handling."
	>
	...
	<meta name="classification" content="Office Shifting and Corporate Relocation Services">
	...
	<meta property="og:title" content="Office Shifting Services in Faridabad – Mourya Packers & Movers">
	<meta property="og:description" content="Efficient, secure and on-time office shifting services in Faridabad with minimal business disruption.">
	...
	<meta name="twitter:title" content="Office Shifting Services in Faridabad | Mourya Packers & Movers">
	<meta name="twitter:description" content="Professional office and corporate relocation services in Faridabad with safe handling and minimal downtime.">
...
<div class="st-breadcumb-area pt-150" style="
  background:
    ...
    url(assets/images/breadcumb/service_3.jpg) no-repeat;
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="breadcumb__top__content text-center wow fadeInUpBig">
					<span>Efficient • Secure • On-Time</span>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="st__section__title mb-50 text-center wow fadeInUp">
					...
					<h1>Professional Office Shifting Services</h1>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 pt-5">
				<div class="st__service__box wow fadeInUp p-relative">
					<div class="st__service__content">
						...
						<h2><a href="#">Office Packing Services</a></h2>
			...
			<div class="col-lg-4 col-md-6 pt-5">
				<div class="st__service__box wow fadeInUp p-relative">
					<div class="st__service__content">
						...
						<h2><a href="#">Safe Office Transportation</a></h2>
						<div class="st__service__btn">
							<a href="#"><i class="bi bi-arrow-right"></i></a>
						</div>
					</div>
			...
			<div class="col-lg-4 col-md-6 pt-5">
				<div class="st__service__box wow fadeInUp p-relative">
					<div class="st__service__content">
						...
						<h2><a href="#">Complete Office Relocation</a></h2>
						<div class="st__service__btn">
							<a href="#"><i class="bi bi-arrow-right"></i></a>
						</div>
					</div>
				...
				<div class="st__contact__inner">
					<div class="st__contact__position">
						<div class="st__section__title mb-50 wow fadeInUp">
							<h5 class="text-white">Plan Your Office Move</h5>
							<h1 class="text-white">Office Shifting Services</h1>
						</div>
						...
						<form action="https://formspree.io/f/maygbqwa" method="post">
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="st__form__box p-relative">
										<input type="text" placeholder="Office Size / Employees*">
								...
								<div class="col-lg-12">
									<div class="st__form__box p-relative">
										<select>
											<option>Select Office Shifting Type</option>
											<option>Local Office Shifting</option>
											<option>Domestic Office Shifting</option>
											<option>Corporate / IT Office Relocation</option>
										</select>
									</div>
								</div>
								...
								<div class="col-lg-12 mt-50">
									<div class="st__form__box">
										<button class="st__btn" type="submit">
											Get Office Shifting Quote <i class="bi bi-arrow-right"></i>
										</button>
									</div>
								</div>
							</div>
