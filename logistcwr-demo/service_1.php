...
<div class="st-breadcumb-area pt-150" style="
  background:
    ...
    url(assets/images/breadcumb/service_1.jpg) no-repeat;
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="breadcumb__top__content text-center wow fadeInUpBig">
					...
					<h2>Household Packing & Shifting</h2>
				</div>
				<div class="breadcumb__links">
					<ul>
						<li><a href="index.php">Home</a></li>
						<li><a href="#"> / </a></li>
						<li><a href="#">Household Packing & Shifting</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="st__section__title mb-50 text-center wow fadeInUp">
					...
					<h1>Household Packing & Shifting Services</h1>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 pt-5">
				<div class="st__service__box wow fadeInUp p-relative">
					<div class="st__service__content">
						...
						<h2><a href="#">Expert Household Packing</a></h2>
			...
			<div class="col-lg-4 col-md-6 pt-5">
				<div class="st__service__box wow fadeInUp p-relative">
					<div class="st__service__content">
						...
						<h2><a href="#">Secure Home Shifting</a></h2>
						<div class="st__service__btn">
							<a href="#"><i class="bi bi-arrow-right"></i></a>
						</div>
					</div>
			...
			<div class="col-lg-4 col-md-6 pt-5">
				<div class="st__service__box wow fadeInUp p-relative">
					<div class="st__service__content">
						...
						<h2><a href="#">Door-to-Door Relocation</a></h2>
						<div class="st__service__btn">
							<a href="#"><i class="bi bi-arrow-right"></i></a>
						</div>
					</div>
				...
				<div class="st__contact__inner">
					<div class="st__contact__position">
						<div class="st__section__title mb-50 wow fadeInUp">
							<h5 class="text-white">Book Your Move</h5>
							<h1 class="text-white">Household Packing & Shifting</h1>
						</div>
						...
						<form action="https://formspree.io/f/maygbqwa" method="post">
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="st__form__box p-relative">
										<input type="text" placeholder="House Size (1BHK / 2BHK / 3BHK)*">
								...
								<div class="col-lg-12">
									<div class="st__form__box p-relative">
										<select>
											<option>Select Shifting Type</option>
											<option>Local Household Shifting</option>
											<option>Domestic Household Shifting</option>
											<option>Interstate Relocation</option>
										</select>
									</div>
								</div>
								...
								<div class="col-lg-12 mt-50">
									<div class="st__form__box">
										<button class="st__btn" type="submit">
											Get Free Shifting Quote <i class="bi bi-arrow-right"></i>
										</button>
									</div>
								</div>
							</div>
